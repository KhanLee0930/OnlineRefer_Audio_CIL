...
def get_args_parser():
    ...
    parser.add_argument('--ytvos_path', type=str, default='/home/user/OnlineRefer_Modified/data/Datasets/ref-youtube-vos')
    ...
    parser.add_argument('--output_dir', default='/home/user/OnlineRefer_Modified/output',
    ...
    # online setting
    parser.add_argument('--audio_online', action='store_true')
    parser.add_argument('--sign_online', action='store_true')
