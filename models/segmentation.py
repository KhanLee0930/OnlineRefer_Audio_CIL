...
class CrossModalFPNDecoder(nn.Module):
    ...
    def forward_features(self, features, audio_features, poses, memory, nf):
        # nf: num_frames
    ...
    def forward(self, features, audio_features, pos, memory, nf):
        ...
        """
        y = self.forward_features(features, audio_features, pos, memory, nf)
